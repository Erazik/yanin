...
// ---------------------------------------------------------
			...
			$options['google_mixed_3'] = array(
								'id' => 'google_mixed_3',
								'std' => array( 'size' => '16px', 'lineheight' => '26px', 'face' => 'Roboto Condensed', 'style' => 'normal', 'character'  => 'latin', 'color' => '#4c4c4c'));

			$options['h1_heading'] = array(
								'id' => 'h1_heading',
								'std' => array( 'size' => '60px', 'lineheight' => '60px', 'face' => 'Pacifico', 'style' => 'normal', 'character'  => 'latin', 'color' => '#222222'));

			$options['h2_heading'] = array(
								'id' => 'h2_heading',
								'std' => array( 'size' => '22px', 'lineheight' => '26px', 'face' => 'Pacifico', 'style' => 'normal', 'character'  => 'latin', 'color' => '#333333'));

			$options['h3_heading'] = array(
								'id' => 'h3_heading',
								'std' => array( 'size' => '18px', 'lineheight' => '22px', 'face' => 'Pacifico', 'style' => 'normal', 'character'  => 'latin', 'color' => '#222222'));

			$options['h4_heading'] = array(
								'id' => 'h4_heading',
								'std' => array( 'size' => '14px', 'lineheight' => '20px', 'face' => 'Roboto Condensed', 'style' => 'normal', 'character'  => 'latin', 'color' => '#333333'));

			$options['h5_heading'] = array(
								'id' => 'h5_heading',
								'std' => array( 'size' => '18px', 'lineheight' => '18px', 'face' => 'Roboto Condensed', 'style' => 'bold', 'character'  => 'latin', 'color' => '#334d67'));
...
// ---------------------------------------------------------
			...
			$options['logo_typography'] = array(
								'id' => 'logo_typography',
								'std' => array( 'size' => '40px', 'lineheight' => '48px', 'face' => 'Pacifico', 'style' => 'normal', 'character'  => 'latin', 'color' => '#049CDB'));
