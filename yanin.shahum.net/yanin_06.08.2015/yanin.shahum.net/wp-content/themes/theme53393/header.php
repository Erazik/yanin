...
<head>
    ...
    <script src="<?php echo  get_stylesheet_directory_uri() ?>/js/jquery.bxslider.js" type="text/javascript"></script>
    <script defer="defer" src="<?php echo  get_stylesheet_directory_uri() ?>/js/custom.js" type="text/javascript"></script>
    <script defer="defer" src="<?php echo  get_stylesheet_directory_uri() ?>/js/jquery.resizecrop.js" type="text/javascript"></script>
...
<body <?php body_class(); ?>>
	<div id="motopress-main" class="main-holder">
        ...
        <?php if ( is_front_page() ) {
         if ( of_get_option( 'px_slider_visibility', 'true' ) == "true" ) { get_template_part('parallax-slider/parallaxSlider'); } } ?>
